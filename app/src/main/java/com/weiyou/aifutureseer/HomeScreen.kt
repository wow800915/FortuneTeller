...
fun HomeScreen(
    ...
    val promptLife = stringResource(R.string.prompt_life)
...
//                onClick = {
//                    if (isNetworkAvailable(context)) {
//                        homeViewModel.sendPrompt(selectedImage.value!!, promptLife)
//                    } else {
//                        Toast.makeText(context, "No network connection", Toast.LENGTH_SHORT).show()
//                    }
//                },
...
//                    .padding(end = 8.dp) // 增加右側距離
//            ) {
//                Text(text = stringResource(R.string.action_life))
//            }
